...
<div class="card card-primary">
	...
	<div class="card-body">
		...
		<div class="form-group row">
			<label for="int" class="col-sm-2 col-form-label">Induk - Grup 2</label>
			<div class="col-sm-10">
				<!-- <input type="text" class="form-control" name="induk" id="induk" placeholder="Induk" value="<?php //echo $induk; ?>" /> -->
				<select class="form-control select2" style="width: 100%;" name="grup2" id="grup2">
					<option value="">-</option>
				</select>
			</div>
		</div>
		...
		<div class="form-group row">
			<label for="int" class="col-sm-2 col-form-label">Induk - Grup 3 <?php echo form_error('induk') ?></label>
			<div class="col-sm-10">
				<!-- <input type="text" class="form-control" name="induk" id="induk" placeholder="Induk" value="<?php //echo $induk; ?>" /> -->
	...
	<div class="card-footer">
		...
		<a href="<?php echo site_url('t73_grup4') ?>" class="btn btn-default">Batal</a>
	</div>
